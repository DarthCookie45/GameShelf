...
| T132 | Edit email page | Clicked Edit Email from the profile page. | Edit email form opens successfully. | Pass | Allows users to maintain the email used for account recovery. |
| T133 | Update email address | Submitted a new unused email address. | Email address updates and profile displays the new email. | Pass | Confirms users can update their account email. |
| T134 | Duplicate email prevention | Tried to update email to one already used by another account. | Form displays an error and prevents the duplicate email. | Pass | Protects password reset emails from being shared across accounts. |
| T135 | Account settings navigation | Viewed profile, edit email and change password pages. | Each page shows consistent Profile, Edit Email and Change Password navigation with the active page highlighted. | Pass | Improves account settings navigation and user experience. |
| T136 | Premium profile insights | Viewed the profile page as a premium user. | Premium Insights section displays below the main profile statistics. | Pass | Confirms premium users receive additional account value. |
| T137 | Premium favourite percentage | Checked the favourite rate in Premium Insights. | Favourite percentage is calculated and displayed correctly. | Pass | Shows an extra collection metric for premium users. |
| T138 | Premium breakdown stats | Viewed format and ownership breakdowns in Premium Insights. | Breakdown lists display counts based on the user's saved games. | Pass | Adds premium-only collection analysis. |
| T139 | Recent play sessions panel | Viewed Premium Insights with no recent play sessions logged. | Page displays a clear no play sessions message. | Pass | Confirms the panel handles empty session history gracefully. |
| T140 | Free user premium teaser | Viewed the profile page as a non-premium user. | User sees an Unlock Premium teaser instead of premium stats. | Pass | Confirms premium-only content is locked for free users. |
| T141 | Google font styling | Viewed pages after adding heading and body fonts. | Headings use themed display font and body text remains readable. | Pass | Improves visual identity without reducing usability. |
| T142 | Active navbar underline | Navigated between Home, Games, Profile and Premium. | Current page displays an accent underline and accent-coloured active link in the navbar. | Pass | Improves navigation feedback. |
| T143 | Account page active navbar | Viewed Profile, Edit Email and Change Password pages. | Profile navbar item remains active across account pages. | Pass | Confirms related account pages are grouped under Profile navigation. |
| T144 | Mobile navbar after visual update | Opened the hamburger menu on a narrow screen. | Mobile navigation opens and displays links correctly. | Pass | Confirms visual polish did not break responsive navigation. |
| T145 | Navbar alignment | Checked desktop navbar after visual updates. | Logout aligns with the other navbar links and brand text is readable. | Pass | Fixes spacing and alignment issues introduced during styling. |
| T146 | Site background image | Viewed multiple pages after adding the GameShelf background image. | Background image displays consistently while page content remains readable. | Pass | Adds visual polish without reducing usability. |
| T147 | Transparent panel styling | Viewed homepage, games list and profile with transparent panels. | Panels show the background subtly while keeping text and form controls readable. | Pass | Confirms the glass-style panels remain usable. |
| T146 | Site background image | Viewed multiple pages after adding the GameShelf background image. | Background image displays consistently while page content remains readable. | Pass | Adds visual polish without reducing usability. |
| T147 | Transparent panel styling | Viewed homepage, games list and profile with transparent panels. | Panels show the background subtly while keeping text and form controls readable. | Pass | Confirms the glass-style panels remain usable. |
| T148 | Game form transparent panels | Viewed the add/edit game form after glass panel styling. | Inner form panels blend with the main panel while fields remain readable. | Pass | Confirms the add/edit form matches the visual style of the rest of the site. |
| T149 | Responsive games table | Viewed the games list at desktop, tablet and mobile widths. | Table content remains inside the panel without horizontal scrolling or text overlap. | Pass | Columns are hidden at smaller widths to keep the games list usable. |
| T150 | Games table actions alignment | Checked View, Add Session, Edit and Delete links across multiple rows. | Action links align correctly within each row. | Pass | Fixed action layout by keeping the table cell separate from the flex action links. |
| T151 | Mobile filter toggle reset | Collapsed filters on a small screen, then resized back to a wider screen. | Filters automatically display again on wider screens. | Pass | JavaScript keeps the filter panel usable when resizing between mobile and desktop. |
...
| T157 | Navbar branding | Replaced text brand with custom GameShelf logo and viewed the navbar on desktop and mobile. | Logo displays clearly, links to the home page and does not break the navbar layout. | Pass | Improves visual identity across the application. |